...
# Defining Training Pipeline config Variables used in training pipeline
...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config:Training_Pipeline_Config):
        # Initializing config variables specifically for data Ingestion
...
# Defining Data Validation Config Class
class DataValidationConfig:
    def __init__(self,training_pipeline_config:Training_Pipeline_Config):
        # Initializing validation config variables inside constructor 
...
# Defining Data Transformation Config
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:Training_Pipeline_Config):
        # Initializing transformation config variables inside constructor 
...
# Defining Model Trainer Config
class ModelTrainerConfig:
    # Initializing training config variables inside container
    def __init__(self,training_pipeline_config:Training_Pipeline_Config):
        
        # Initializing trainer config variables inside constructor 
